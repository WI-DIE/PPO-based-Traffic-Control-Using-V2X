...
K_EPOCH = 4                # PPO 학습 반복 횟수
T_HORIZON = 500           # 한 에피소드에서 수집할 step 수
ENTORPYCOEFF = 0.2
# === 에이전트 설정 ===
STATE_DIM = 40             # 상태 벡터 차원 (state 정의에 따라 수정 가능)
ACTION_DIM = 5             # 행동 차원 (ex. 4개의 신호 조합 등)
HIDDEN_DIM = 128            # NN 히든 레이어 차원

# === 학습 설정 ===
MAX_EPISODES = 300       # 총 학습할 에피소드 수
LOG_INTERVAL = 5          # 몇 에피소드마다 로그 출력
